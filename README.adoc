...
:page-description: Learn how to use JAX-RS, CDI, and JSON-P to build a MicroProfile application.
...
Annotate `InventoryManager` with `@ApplicationScoped` because it, too, does not depend on any request-specific state.
