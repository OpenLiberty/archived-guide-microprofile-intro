...
First, create the JAX-RS service that serves as the `systems` endpoint. Create an empty file with the following file name:
`src/main/java/io/openliberty/guides/microprofile/InventoryResource.java`

Next, paste the following code into the empty file:
[source, java]
----
