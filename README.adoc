...
applications. It simplifies dependency and lifecycle management and enable developers to focus on
their code.
...
In general, all resources should be annotated with `@ApplicationScoped` unless they should be created once
per every request.
