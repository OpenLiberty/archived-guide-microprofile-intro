...
public class EndpointTest {
    ...
    public void testHostRegistration() {
        ...
        Response invResponse = this.getResponse(invBaseUrl + INVENTORY_SYSTEMS);
        this.assertResponse(invBaseUrl, invResponse);
        ...
        boolean actualLocalhost = obj.getJsonObject("systems").containsKey("localhost");
    ...
    public void testSystemPropertiesMatch() {
        Response invResponse = this.getResponse(invBaseUrl + INVENTORY_SYSTEMS);
        Response sysResponse = this.getResponse(sysBaseUrl + SYSTEM_PROPERTIES);
        this.assertResponse(invBaseUrl, invResponse);
        this.assertResponse(sysBaseUrl, sysResponse);
    ...
    public void testUnknownHost() {
        ...
        Response badResponse = client.target(invBaseUrl + INVENTORY_SYSTEMS + "/" + "badhostname")
